            ...
            <div class="col-md-10">
                <div class="timeline-wrapper clearfix">
                    ...
                    @foreach($tasks as $k=>$task)
                                    ...
                                    <div class="timeline-item-inner">
                                        <div class="timeline-body">
                                            <div class="timeline-avatar">
                                                <img src="{{$task->company->poster}}" alt="" class="img-circle">
                                            </div>
                                            ...
                                            <div class="timeline-ctrl">
                                                ...
                                                <div class="col-lg-5 col-md-5 col-sm-5 timeline-select">
                                                    <select name="c{{$task->company_id}}" class="form-control">
                                                        @foreach($task->salaryModels as $salaryModel)
                        ...
                        @elseif($task->deal_time>=$nextMonthTime && $tasks[$k-1]['deal_time']<$nextMonthTime)
                                    ...
                                    <div class="timeline-item-inner">
                                        <div class="timeline-body">
                                            ...
                                            <div class="timeline-ctrl">
                                                ...
                                                <div class="col-lg-5 col-md-5 col-sm-5 timeline-select">
                                                    <select name="c{{$task->company_id}}" class="form-control">
                                                        @foreach($task->salaryModels as $salaryModel2)
        ...
        $("#createLittle").click(function () {
            ...
            if (littleCategory != "") {
                ...
                $.ajax(url, {
                    ...
                    dataType: 'json',
                    timeout: '120000',
                    data: {name: littleCategory, level: 2},
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    }
                }).done(function (data) {
