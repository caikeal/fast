...
@section('content')
    ...
    <section>
        ...
        <div class="contact-list">
            <h2 style="font-size: larger;margin-bottom: 0;padding: 0 1rem">薪资查询联系人</h2>
        ...
        <div class="contact-list">
            <h2 style="padding: 0 1rem;font-size: larger;margin-bottom: 0;">社保查询联系人</h2>
            <hr style="margin: .5rem"></hr>
            <div class="am-u-sm-4 am-u-md-4 am-u-lg-4">
                <a href="javascript:void(0);" class="am-badge am-badge-danger am-round" style="line-height: 1.6"><i class="am-icon-user am-round"></i></a>
        ...
        <div class="contact-list">
            <h2 style="padding: 0 1rem;font-size: larger;margin-bottom: 0;">理赔查询联系人</h2>
            <hr style="margin: .5rem"></hr>
            <div class="am-u-sm-4 am-u-md-4 am-u-lg-4">
